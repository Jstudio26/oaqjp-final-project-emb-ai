...
class TestEmotionDetector(unittest.TestCase):
    ...
    def test_disgust_dominant(self):
        """Test that 'I feel disgusted just hearing about this' returns disgust as dominant."""
    ...
    def test_fear_dominant(self):
        """Test that 'I am really afraid that this will happen' returns fear as dominant."""
